...
class Repository {
  static List<String> formatDate(DateTime datetime) {
  ...
  static IconData iconForCategory(String Transcategory) {
    int idx = 0;
  ...
  static String findCategory(String desc) {
  ...
  static List<double> getAmount(List<Finance> Records) {
    double income = 0;
    double expense = 0;
  ...
  static double getAmountByCategory(List<Finance> Records, String Catergory) {
    double amount = 0;
  ...
  static double getamtforBudget(
      DateTime date, String category, String duration) {
    double amount = 0;
    if (duration == "Yearly") {
      amount = getAmountByCategory(
          DbRepository.getRecords()
              .where((element) =>
  ...
  static Map<int, List<double>> getAmountByDate(List<Finance> records) {
  ...
  static Map<int, List<double>> getAmountByMonth(List<Finance> records) {
  ...
  static List<String> getYearList(List<Finance> records) {
  ...
  static bool checkIfExist(Finance rec) {
  ...
  static void action(summaryProvider provider, transactionProvider tprovider) {
    provider.updateValues(0, 0);
    provider.updateRecords();
    tprovider.updateRecords(0, 0);
  }

  static String getCategoryFromDesc(String desc) {
    if (desc.contains("/") && desc.split("/").length > 3) {
      desc = desc.split("/")[3];
      List<Finance> Records = DbRepository.getRecords()
  ...
  static Future addRecordFromMsg(
  ...
  static Future<String?> pickXLSXFile() async {
  ...
  static List<List<dynamic>> parseXLSXFile(String filePath) {
